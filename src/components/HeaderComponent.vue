<template>
  <header id="header" class="sticky-top">
    ...
    <nav
      class="
        primary-menu
        navbar navbar-expand-none navbar-overlay navbar-overlay-dark
        bg-transparent
        border-bottom-0
        text-5
        fw-600
    ...
    >
      <div class="container">
        <!-- Logo -->
        <a class="logo" href="/" title="Theodore">
          <p class="text-4">THEODORE</p>
        </a>
        <!-- Logo End -->
        <div class="text-3 ms-auto me-2">
          <span class="text-4 me-2"><i class="fas fa-phone"></i></span>+2349049460816
        </div>
        <button
        ...
        <div id="header-nav" class="collapse navbar-collapse">
          ...
          >
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link smooth-scroll active" href="#resume"
                  >Resume</a
                >
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link smooth-scroll" href="#testimonial"
                  >Client Speak</a
                >
              </li>
              <li class="nav-item">
                <a class="nav-link smooth-scroll" href="#contact">Contact Me</a>
              </li>
            </ul>
            <ul
              class="
