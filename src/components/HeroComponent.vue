  ...
  <section>
    <div class="hero-wrap">
      ...
      <div class="hero-bg parallax"
           :style="`background-image: url('../images/intro-bg-2.jpg'); background-size: cover; background-repeat: no-repeat; background-attachment: fixed; background-position: center 1780.38px;`"></div>
