    ...
    <div class="container">
      ...
      <div class="portfolio wow fadeInUp" style="visibility: hidden; animation-name: none;">
        <div class="row g-4 mt-3 portfolio-filter" style="position: relative; height: 1152px;">
          <div class="col-sm-6 col-lg-4 detailed" style="position: absolute; left: 0px; top: 0px;">
            <div class="portfolio-box">
              <div class="portfolio-img"><img class="img-fluid d-block" src="images/project-1.jpg" alt>
          ...
          <div class="col-sm-6 col-lg-4 mockups" data-wow-delay="0.2s"
            ...
            <div class="portfolio-box">
              <div class="portfolio-img"><img class="img-fluid d-block" src="images/project-2.jpg" alt>
                <div class="portfolio-overlay"><a class="popup-img stretched-link"
                                                  href="images/projects/project-2.jpg"></a>
                  <div class="portfolio-overlay-details">
          ...
          <div class="col-sm-6 col-lg-4 youtube" data-wow-delay="0.3s"
               style="position: absolute; left: 0px; top: 384px;">
            <div class="portfolio-box">
              <div class="portfolio-img"><img class="img-fluid d-block" src="images/project-3.jpg" alt>
                <div class="portfolio-overlay"><a class="popup-youtube stretched-link"
                                                  href="https://www.youtube.com/watch?v=PMNnEEEacCg"></a>
                  <div class="portfolio-overlay-details">
          ...
          <div class="col-sm-6 col-lg-4 vimeo" style="position: absolute; left: 360px; top: 384px;">
            <div class="portfolio-box">
              <div class="portfolio-img"><img class="img-fluid d-block" src="images/project-4.jpg" alt>
                <div class="portfolio-overlay"><a class="popup-vimeo stretched-link"
                                                  href="https://vimeo.com/259411563"></a>
                  <div class="portfolio-overlay-details">
                    <p class="text-primary text-8"><i class="fas fa-video"></i></p>
          ...
          <div class="col-sm-6 col-lg-4 detailed" data-wow-delay="0.2s"
               style="position: absolute; left: 0px; top: 768px;">
            <div class="portfolio-box">
              <div class="portfolio-img"><img class="img-fluid d-block" src="images/project-5.jpg" alt>
                <div class="portfolio-overlay"><a class="popup-ajax stretched-link"
          ...
          <div class="col-sm-6 col-lg-4 mockups" data-wow-delay="0.3s"
               style="position: absolute; left: 360px; top: 768px;">
            <div class="portfolio-box">
              <div class="portfolio-img"><img class="img-fluid d-block" src="images/project-6.jpg" alt>
                <div class="portfolio-overlay"><a class="popup-img stretched-link"
                                                  href="images/projects/project-6.jpg"></a>
                  <div class="portfolio-overlay-details">
                    <p class="text-primary text-8"><i class="fas fa-image"></i></p>
