<template>
  <section id="services" class="section bg-light">
    <div class="container">
      <!-- Heading -->
      <p class="text-center mb-2 wow fadeInUp" style="visibility: visible;"><span class="bg-primary text-dark px-2">What I Do?</span>
      </p>
      <h2 class="text-10 fw-600 text-center mb-5 wow fadeInUp" style="visibility: visible;">How I can help your next
        project</h2>
      <!-- Heading end-->
      ...
      <div class="row gy-5 mt-5">
        <div class="col-sm-6 col-lg-4 wow fadeInUp" style="visibility: visible;">
          <div class="featured-box text-center px-md-4">
            ...
            <p class="text-muted mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
